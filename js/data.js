/*
0 : virgin #ff6e7f, #bfe9ff
1 : Noon to Dusk
2 : Nighthawk #cc95c0, #dbd4b4, #7aa1d2
3 : Monte Carlo #2980b9, #2c3e50
4 : Red ocean #1d4350, #a43931
5 : Tranquil #eecda3, #ef629f
6 : Mauve #42275a, #734b6d
7 : shebert #f79d00, #64f38c
8 : Roseanna #ffafbd, #ffc3a0
9 : Wedding Day Blues , #ff8c00,  
10 : Minimal #c6ffdd, #fbd786, #f7797d
11 : Purple Bliss #360033, #0b8793
...
const qnaList = [
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 긴가민가.. 말은 꺼내지 않는다', type: [2, 4, 9] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 마음 졸이며 SNS에 들어가 연인이 활동중 상태인지 확인한다.', type: [1, 3, 6, 11] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 갑자기 오면 어떡해.. 불쑥 찾아오면 곤란해', type: [4, 9, 11] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. "따라오지마 오늘 집 갈 거니까." 라고 말하며 집으로 간다.', type: [3, 6, 4, 9] },
      { answer: 'b. "내 말은 그게 아니잖아" 은은하게 화난 상태를 표시한다.', type: [0, 2, 5, 10, 8] },
